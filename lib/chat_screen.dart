...
class ChatScreen extends StatefulWidget {
  static String id='welcoom_screen';
  @override
...
class MesaagesStream extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return  StreamBuilder<QuerySnapshot>(
      ...
      builder: (context,snapshot){
        ...
        List<MessagesBubble> messagesBubble=[];
        for(var message in messages )
        {
          ...
          final messageBubble= MessagesBubble(sender: messageSender,text: messageText,isMe:currentUser==messageSender);
